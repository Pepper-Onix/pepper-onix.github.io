var store = [{
        ...
        "excerpt":"## Level 3 to Level 4 ### THE LEVEL'S STATEMENT >The password for the next level is stored in a hidden file in the inhere directory. ### COMMANDS > *ls - list directory contents.* > *cd - change working directory.* > > *cat - concatenate files and print on the...","categories": ["OverTheWire"],
        "tags": ["bandit"],
        "url": "http://localhost:4000/bandit-3-to-6.md/",
        "teaser":"http://localhost:4000/assets/images/htb-writeup-delivery/delivery_logo.png"},{
